...
# -----------------------------
# 1) Data: 30 common spam words/phrases
# -----------------------------
...
def scan_text_for_words(text: str, vocab: set[str]):
    ...
    ### Count occurrences of each spam WORD (single-token) in the message. ###
...
def likelihood_label(score: int):
    ...
    ### Map score ###
    ### You can tweak these bands to be stricter/looser. ###
...
def main():
    ...
    # Optional: show raw breakdowns
    # print("\nWord counts:", dict(result["word_counts"]))
    # print("Phrase counts:", dict(result["phrase_counts"]))
